# -*- coding: utf-8 -*-
"""
Created on Mon Aug 31 22:39:37 2020
...
model = load_model('model_fcn_1182.h5')
...
for i_ in range(len(ytest_list1)):  
    ...
    imx2.save("outputs_fcn_1182/label"+str(i_+1)+".jpg")
...
for i_ in range(len(xtest_list1)):
    ...
    imx1.save("outputs_fcn_1182/yunatu"+str(i_+1)+".jpg")
    imx.save("outputs_fcn_1182/out"+str(i_+1)+".jpg")
